...
const servicesMenu = [
  ...
  },
  {
    ...
    submenu: [
      { name: "AML/CFT POLICY & PROCEDURES", href: "/aml-cft-policy" },
      ...
      { name: "AML REGULATORY REPORTING", href: "/amlregulatoryreporting" },
      { name: "KYC AND CDD SERVICES", href: "/kycandcddservices" },
    ],
  },
