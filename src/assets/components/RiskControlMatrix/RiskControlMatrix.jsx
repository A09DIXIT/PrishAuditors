...
const RiskControlMatrix = () => {
  ...
  return (
    <section key={replayKey} className="pt-0 pb-20 bg-white max-w-8xl mx-auto">
      ...
      <div className="px-6 md:px-16 mt-10 max-w-8xl mx-auto">
        ...
        >
          ...
          <motion.div
            ...
            variants={container}
          >
            <motion.p className="mb-5 text-[#0a2d45]" variants={slideRtoL}>
            ...
            <motion.p className="mb-5 text-[#0a2d45]" variants={slideLtoR}>
            ...
            <motion.p className="text-[#0a2d45]" variants={slideRtoL}>
      ...
      {/* Why Choose PRISH — alternating slides, re-triggers on view */}
      ...
      {/* FAQ — same pattern (container + stagger + fadeUp + accordion) */}
      <motion.div
        variants={container}
        initial="hidden"
        whileInView="show"
                    ...
                    >
                      {Array.isArray(item.answer)
                        ...
                        : typeof item.answer === "string"
                          ? <p>{item.answer}</p>
                          : item.answer /* render JSX nodes (like <ul> ...) */}
                    </div>
                  </motion.div>
                )}
              </AnimatePresence>
